...
// import { BadgeInfo, Check, CheckCircle2, Lock, PlayCircle } from "lucide-react";
...
//                 controls={true}
//                 light={course.courseThumbnail || "/default-thumbnail.jpg"} // fallback if no thumbnail
//               />

//               </div>
//               <div className="flex items-center mt-[15px]">
//                 <CheckCircle2 size={24} className="text-green-500 mx-2" />
//                 <h1>Boost Your Skills, Elevate Your Career!</h1>
//               </div>
...
//               <div className="flex items-center mt-[15px]">
//                 <CheckCircle2 size={24} className="text-green-500 mx-2" />
//                 <h1>Learn Fast, Earn Faster!</h1>
//               </div>
//               <Separator className="my-2" />
//               <h1 className="text-lg md:text-xl font-semibold">Course Price 
...
//                 Course Price <span>${course?.coursePrice}</span>
//               </h1>
//             </CardContent>
//             <CardFooter className="flex justify-center p-4">
//               {purchased ? (
