...
const Becomeaninstructor = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 text-gray-200 bg-gray-900">
      {/* Banner */}
      <div className="bg-gradient-to-r from-indigo-700 to-indigo-900 text-white p-8 rounded-lg shadow-md mb-10 text-center">
      ...
      {/* Contact Form */}
      <section className="bg-gray-800 p-8 rounded-2xl shadow-lg max-w-4xl mx-auto mt-10">
        <h2 className="text-3xl font-bold text-indigo-400 mb-2 text-center">Interested in Working with Us?</h2>
        ...
        <form onSubmit={handleSubmit} className="grid gap-6" aria-label="Instructor Application Form">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-gray-700 text-gray-200 border border-gray-600 p-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="phone" className="block text-gray-300 font-medium mb-2">Your Phone</label>
              <input
                type="tel"
                id="phone"
                name="phone"
            ...
            <div>
              <label htmlFor="course" className="block text-gray-300 font-medium mb-2">Select Course</label>
              <select
                id="course"
                name="course"
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows="5"
              className="w-full bg-gray-700 text-gray-200 border border-gray-600 p-3 rounded-lg shadow-sm resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ></textarea>
          </div>
        ...
        {isSuccess && (
          <p className="text-green-400 mt-6 text-center font-medium">Form submitted successfully!</p>
        )}
        {error && (
