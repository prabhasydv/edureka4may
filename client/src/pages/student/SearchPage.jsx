...
const SearchPage = () => {
  ...
  const [selectedCategories, setSelectedCatgories] = useState(categoriesFromURL);
  const [sortByPrice, setSortByPrice] = useState(sortFromURL);
  ...
  const handleFilterChange = (categories, price) => {
    ...
    if (categories.length > 0) {
      newParams.set("query", categories.join(","));
    }
    ...
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        <Filter
          ...
          selectedCategories={categoriesFromURL}
          selectedSort={sortByPrice}
        />
...
// ... CourseNotFound and CourseSkeleton stay unchanged
