      ...
      <div className="max-w-7xl mx-auto hidden md:flex justify-between items-center gap-10 h-full">
        ...
        <div className="flex items-center gap-3 w-full max-w-lg" ref={dropdownRef}>
          ...
          {isOpen && (
            ...
            //   <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-screen-xl mx-auto px-6 py-6 bg-white rounded-xl dark:bg-gray-900 shadow-2xl">
            //     {/* <div className="bg-white dark:bg-gray-900 shadow-xl border-t border-gray-200 dark:border-gray-700 px-6 py-6 rounded-xl"> */}


            //     {/* Category 1: Project Management */}
            //     <div>
            //       <h3 className="flex items-center font-semibold text-gray-800 dark:text-gray-100 mb-2 underline">
            ...
            //         <li>
            //           <a
            //             href="/course/search?query=PMP"
            //             // href="/course-detail/680ddfbe47407153686f6d27"
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://d2o2utebsixu4k.cloudfront.net/mega_menu/prince-2-practitioner-and-foundation.svg" className="w-5 h-5" />
            //             PMP
            //           </a>
            //         </li>
            //         <li>
            //           <a
            //             href="/course/search?query=CAPM"
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://d2o2utebsixu4k.cloudfront.net/mega_menu/Microsoft-Power-BI.svg" className="w-5 h-5" />
            //             CAPM
            //           </a>
            //         </li>
            //         <li>
            //           <a
            //             href="/course/search?query=RMP"
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://img.icons8.com/color/48/000000/cyber-security.png" className="w-5 h-5" />
            //             RMP
            //           </a>
            //         </li>
            //         <li>
            //           <a
            //             href="/course/search?query=Prince"
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://img.icons8.com/color/48/000000/source-code.png" className="w-5 h-5" />
            //             Prince 2 Foundation
            //           </a>
            //         </li>
            //         <li>
            ...
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://img.icons8.com/color/48/000000/blockchain-technology.png" className="w-5 h-5" />
            //             Prince 2 Practitionary
            //           </a>
            //         </li>
            //         <li>
            //           <a
            ...
            //     <div>
            //       <h3 className="flex items-center font-semibold text-gray-800 dark:text-gray-100 mb-2 underline">
            //         <FiDatabase className="mr-2 text-neutral-500" />
            //         Data Science
            //       </h3>
            //       <ul className="space-y-1">
            //         <li>
            //           <a
            //             href="/bi-visualization"
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://d2o2utebsixu4k.cloudfront.net/mega_menu/AWS.svg" className="w-5 h-5" />
            ...
            //     <div>
            //       <h3 className="flex items-center font-semibold text-gray-800 dark:text-gray-100 mb-2 underline">
            //         <FiCloud className=" mr-2 text-neutral-500" />
            //         Cloud Computing
            //       </h3>
            //       <ul className="space-y-1">
            //         <li>
            ...
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://d2o2utebsixu4k.cloudfront.net/assets/resources/CSM.svg" className="w-5 h-5" />
            //             AWS Certification
            //           </a>
            //         </li>
            //         <li>
            ...
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://img.icons8.com/color/48/000000/azure-1.png" className="w-5 h-5" />
            //             Microsoft Azure
            //           </a>
            //         </li>
            //         <li>
            ...
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://img.icons8.com/color/48/000000/google-cloud.png" className="w-5 h-5" />
            //             Google Cloud
            //           </a>
            //         </li>
            //         <li>
            ...
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://d2o2utebsixu4k.cloudfront.net/mega_menu/DevOps.svg" className="w-5 h-5" />
            //             DevOps
            //           </a>
            //         </li>
            //         <li>
            ...
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img src="https://img.icons8.com/color/48/docker.png" className="w-5 h-5" />
            //             Docker & Kubernetes
            //           </a>
            //         </li>
            //       </ul>
            ...
            //     <div>
            //       <h3 className="flex items-center font-semibold text-gray-800 dark:text-gray-100 mb-2 underline">
            //         <FiGitCommit className="mr-2 text-neutral-500" />
            ...
            //     <div>
            //       <h3 className="flex items-center font-semibold text-gray-800 dark:text-gray-100 mb-2 underline">
            //         <FaTerminal className="mr-2 text-neutral-500" />
            //         DevOps
            //       </h3>
            //       <ul className="space-y-1">
            //         {/* Direct link items */}
            ...
            //           >
            //             <img
            //               src="https://d2o2utebsixu4k.cloudfront.net/assets/resources/CSM.svg"
            //               className="w-5 h-5"
            //             />
            //             Docker & Kubernetes
            //           </Link>
            ...
            //     {/* Category 6: BI & Visualization */}
            //     <div>
            //       <h3 className="flex items-center font-semibold text-gray-800 dark:text-gray-100 mb-2 underline">
            //         <MdBarChart className="mr-2 text-neutral-500 text-xl" />
            //         BI & Visualization
            //       </h3>
            //       <ul className="space-y-1">
            //         <li>
            //           <Link
            //             href="/courses/ethereum-development"
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img
            //               src="https://d2o2utebsixu4k.cloudfront.net/mega_menu/AWS.svg"
            //               className="w-5 h-5"
            //             />
            //             Power BI / Tableau
            //           </Link>
            ...
            //     {/* Category 7: Cyber Security */}
            //     <div>
            //       <h3 className="flex items-center font-semibold text-gray-800 dark:text-gray-100 mb-2 underline">
            //         <FiShield className="mr-2 text-neutral-500" />
            //         Cyber Security
            //       </h3>
            //       <ul className="space-y-1">
            //         <li>
            ...
            //         {/* <li>
            //           <button
            //             onClick={() => toggleSubmenu("web")}
            //             className="flex justify-between items-center w-full text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <div className="flex items-center gap-2">
            //               <img src="https://d2o2utebsixu4k.cloudfront.net/mega_menu/AWS.svg" className="w-5 h-5" />
            //               MERN Stack
            //             </div>
            //             <ChevronDownIcon className={`w-4 h-4 transition-transform ${activeSubmenu === "web" ? "rotate-180" : ""}`} />
            //           </button>
            //           {activeSubmenu === "web" && renderSubmenu("web")}
            //         </li> */}
            //         <li>
            //           <Link
            //             href="/courses/ethereum-development"
            ...
            //     {/* Category 9: Blockchain */}
            //     <div>
            //       <h3 className="flex items-center font-semibold text-gray-800 dark:text-gray-100 mb-2 underline">
            //         <FaCube className="mr-2 text-neutral-500" />
            //         Blockchain
            //       </h3>
            //       <ul className="space-y-1">
            //         {/* Direct Links */}
            //         <li>
            //           <Link
            //             href="/courses/web3-fundamentals"
            //             className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
            //           >
            //             <img
            //               src="https://d2o2utebsixu4k.cloudfront.net/assets/resources/CSM.svg"
